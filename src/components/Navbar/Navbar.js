...
const Navbar = () => {
  ...
  return (
    <header className="flex items-center sticky top-0 z-50 bg-white px-4 py-2 shadow-md">
      <Button color="gray" className="!hidden md:!inline-block h-12 w-12 border-0">
      ...
      {/* Spacer for left-side alignment */}
      <div className="flex-grow"></div>

      {user && (
        <div className="w-[500px] flex items-center px-5 py-2.5 bg-gray-100 rounded-full text-gray-600 focus-within:shadow-md focus-within:bg-white mr-[14rem]">
