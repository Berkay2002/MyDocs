  ...
  return (
    <header className="flex items-center sticky top-0 z-50 bg-white px-4 py-2 shadow-md">
      ...
      <Link href="/" legacyBehavior>
        ...
        <Image src="/logo-2-docs.ico" alt="Logo" width={50} height={50} />
        </a>
      </Link>
      ...
      {user && (
        <>
          <div className="mx-5 md:!mx-20 flex flex-1 items-center px-5 py-3 bg-gray-100 rounded-full text-gray-600 focus-within:shadow-md focus-within:bg-white">
